...
class OWMine(OWWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        row = 0
        self.query_edit2 = ListEdit(self, 'query_list', "Each line represents a separate query."
                                                       , 30, self)
        ...
        layout.addWidget(self.query_edit2, row, self.label_width, 1,
                         self.widgets_width)
    ...
    def search(self):
        ...
        #print(self)
        #print('FFFFFFFFFFFF2')
        tempd = self.api.search(lang=self.language, queries=self.query_list,
